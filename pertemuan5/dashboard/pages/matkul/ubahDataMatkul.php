...
<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE dosen SET nama = '$namaMatkul', deskripsi = '$deskripsiMatkul' WHERE id = '$id'";
...
?>
   <?php include "../../components/header.php"; ?>
    ...
    <form action="" method="post" class="border border-success p-4 rounded shadow">
                    ...
                    <input type="text" name="nama" class="form-control" maxlength="12" value="<?php echo $row['nama'];?>" required>
                    </div>
